...
export default function BookingCard({ booking, onCancel }) {
  ...
  return (
    <div className="glass-card" style={{ padding: '1.5rem' }}>
      ...
      {booking.flight && (
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '1rem', background: 'rgba(var(--primary-rgb), 0.08)', borderRadius: '8px', marginBottom: '1rem', flexWrap: 'wrap' }}>
        ...
        <div style={{ marginBottom: '1rem' }}>
          ...
          <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
            {booking.passengers.map((p, i) => (
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', padding: '4px 10px', background: 'rgba(var(--primary-rgb), 0.12)', borderRadius: '999px', fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
